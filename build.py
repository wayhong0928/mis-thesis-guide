...
NAV = [
    ...
    ("研究方法", [
        ("methodology", "方法論選擇地圖", "研究問題分流、方法適配與相對代價"),
        ("research-ethics-data", "研究倫理與資料管理", "倫理審查、知情同意、風險與資料生命週期"),
        ("systematic-review", "系統性回顧與範疇回顧", "問題界定、可重做檢索、篩選、擷取與綜整"),
        ("quant-analysis-basics", "量化分析規劃與資料處理基礎", "分析計畫、資料字典、清理、假設檢查與可重現紀錄"),
        ...
        ("method-secondary-data", "次級資料分析與檔案研究", "資料來源適配、使用權限、證據脈絡與穩健性檢查"),
    ...
    ("論文寫作", [
        ...
        ("post-defense", "口試後修訂、典藏與結案", "修訂回覆、版本控制、授權送存、離校與研究結案"),
    ]),
    ("AI 輔助研究", [
...
<p>把學習筆記、方法論書籍、公開規範與 AI 輔助研究的實務整理成一張可以反覆查閱的地圖。內容涵蓋研究的本質、研究倫理、證據綜整、量化基礎與多種研究設計，以及論文寫作、口試和結案。</p>
